...
export default function RelatedPlaceSections({ 
  ...
  const [data, setData] = useState<any>({
    ...
    cityPlaces: [],
    cityVendors: [],
    categoryPlaces: {}, // 🌟 NAYA: Categories ke hisaab se places store karne ke liye
    topTours: [],
    topCabs: [],
    topPlaces: []
  });
    ...
    async function fetchRelatedData() {
      try {
        const [
          ...
          { data: topCabs },
          { data: topPlaces },
          { data: currentPlace },   // 🌟 NAYA: Current place ki categories nikalne ke liye
          { data: allDestinations } // 🌟 NAYA: Category matching ke liye places ka pool
        ] = await Promise.all([
          // Tours in this city
        ...
        // 🌟 Har category ke liye alag se places filter karna
        ...
        currentCategories.forEach(cat => {
          ...
          // Agar is category ke places mil gaye, toh list me add karo (Max 8 cards)
        ...
        setData({
          ...
          categoryPlaces: catPlacesResult, // 🌟 Save the dynamic categories
          topTours: topTours || [],
          topCabs: topCabs || [],
          topPlaces: topPlaces || []
        });
  ...
  // 🌟 NAYA: Code clean rakhne ke liye common Place Card renderer
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 md:px-12 mt-6 space-y-12">
      ...
      {/* 🌟 NAYA SECTION: Dynamic Category Sliders */}
