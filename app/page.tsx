...
export const metadata: Metadata = {
  ...
  keywords: 'India tour operators, tour packages India, cab booking, hotel booking, travel agency India, local guides, India tourism'
}
...
const homeFaqs = [
  ...
  { q: "Are there any hidden booking fees?", a: "No! We believe in 100% transparency. The prices you see are directly from the local operators with zero hidden charges or surprise platform fees." },
  { q: "How do I know the travel agents are genuine?", a: "We have a rigorous vetting process. Every travel agency, hotel, and cab provider listed on our portal is manually verified for quality, safety, and past customer satisfaction." },
...
export default async function Home() {
  ...
  return (
    <main className="min-h-screen bg-slate-50 font-sans selection:bg-blue-200 selection:text-blue-900">
      ...
      <section className="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-slate-900 text-white py-20 px-4 md:px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center mb-12">
          ...
          <h1 className="text-4xl md:text-6xl font-black mt-2 mb-6 leading-tight tracking-tight drop-shadow-lg">
            Discover Incredible India with <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-400 to-amber-300">Expert Locals</span>
          </h1>
          <p className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto font-medium opacity-90">
            Explore verified holiday packages, comfortable outstation cabs, and premium hotels handpicked for your ultimate dream vacation.
          </p>
        </div>
      ...
      {/* --- 📝 NEW: SEO KEYWORD TEXT & FAQ SECTION --- */}
            ...
            <div className="bg-gradient-to-br from-slate-50 to-blue-50/50 p-8 md:p-12 rounded-[2.5rem] border border-blue-100 shadow-sm relative overflow-hidden">
              ...
              <div className="relative z-10 text-center max-w-4xl mx-auto">
                ...
                <div className="space-y-6 text-slate-600 text-lg md:text-xl leading-relaxed font-medium">
                  <p>
                    Welcome to <strong className="text-slate-900 font-black">India Tour Operators</strong>, the leading aggregator platform connecting travelers with verified, top-rated local travel agencies across India. Whether you are looking for customized <strong className="text-blue-600 font-black">India tour packages</strong>, reliable <strong className="text-blue-600 font-black">outstation cab booking</strong> services, or luxurious yet affordable <strong className="text-blue-600 font-black">hotel bookings</strong>, we have everything organized in one place.
                  </p>
                  <p>
                    Our platform eliminates the middleman, ensuring that you get the most authentic travel experiences directly from local experts at highly competitive prices. Explore detailed <strong className="text-slate-800 font-bold border-b-2 border-amber-300">tourist place guides</strong>, read our expert <strong className="text-slate-800 font-bold border-b-2 border-amber-300">travel blogs</strong>, and plan your next vacation to trending destinations like Kerala, Rajasthan, Kashmir, and Goa with complete peace of mind.
                  </p>
                </div>
              </div>
            </div>
